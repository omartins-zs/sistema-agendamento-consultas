...
class MedicoDisponivel implements DataAwareRule, ValidationRule
{
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        ...
        $query = Consulta::where('medico_id', $value)
        ...
        if ($query->exists()) {
            $fail('O médico já possui uma consulta agendada neste horário.');
        }
    }
}
